          ...
          <div class="container bg-dark" >
            <div class="row align-items-center py-lg-8 py-4 px-3">
              <div class="col-md-12 text-center text-lg-start">
                <h1 class="text-white fs-5 fs-xl-6 fw-bolder">Bookings</h1>
              </div>
                    ...
                    <div class="col-md-12 mb-3">
                      <div class="row">
                        ...
                        <div class="col-md-2 mb-2" style="height:auto;">
                          <a href="rooms.php"><button class="btn btn-outline-success form-control text-white" > Rooms</button></a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody id="myTable">
    <?php 
                      $query=mysqli_query($con,"select booking.*, tblusers.*, rooms.* from booking, tblusers, rooms where tblusers.id=booking.user and rooms.id=booking.room order by booking.saved_at desc");
                      $n=1;
